...
export const saveNotionToken = (token: string) => safeSetItem(NOTION_TOKEN_KEY, token.trim());
...
export const saveNotionClientId = (id: string) => safeSetItem(NOTION_CLIENT_ID_KEY, id.trim());
export const getStoredNotionClientSecret = (): string => localStorage.getItem(NOTION_CLIENT_SECRET_KEY) || '';
export const saveNotionClientSecret = (secret: string) => safeSetItem(NOTION_CLIENT_SECRET_KEY, secret.trim());
