...
const CollegeView: React.FC<CollegeViewProps> = ({ 
            ...
            return (
                <div className="flex flex-col gap-8">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl">Course Items</h3>
                        <div className="grid grid-cols-1 gap-4">
                            {(memoriesByCourse[selectedCourse] || []).map(mem => (
                                <button 
                                    key={mem.id}
    ...
    return (
        <div className="flex flex-col gap-8">
            {/* Main Tabs */}
            <div className="flex gap-2 bg-[#60A5FA]/10 rounded-2xl p-2">
                <button 
                    onClick={() => { setMainTab('courses'); setView('list'); }}
                    className={`flex-1 py-4 rounded-xl font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${mainTab === 'courses' ? 'bg-[#60A5FA] text-[#020617]' : 'text-[#60A5FA]'}`}
                >
                    <LayoutGrid size={20} />
                ...
                <button 
                    ...
                    className={`flex-1 py-4 rounded-xl font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${mainTab === 'files' ? 'bg-[#60A5FA] text-[#020617]' : 'text-[#60A5FA]'}`}
                >
                    <FileStack size={20} />
                ...
                <button 
                    ...
                    className={`flex-1 py-4 rounded-xl font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${mainTab === 'tasks' ? 'bg-[#60A5FA] text-[#020617]' : 'text-[#60A5FA]'}`}
                >
                    <ListTodo size={20} />
