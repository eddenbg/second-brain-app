...
const CollegeView: React.FC<CollegeViewProps> = ({ lectures, onSave, onDelete, onUpdateTitle, bulkDelete }) => {
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                    <h2 className="text-2xl font-bold text-white">My Lectures</h2>
                     {lectures.length > 0 && (
                        <button 
                            onClick={() => {
                ...
                {filteredLectures.length === 0 ? (
                    ...
                    filteredLectures.map(lec => (
                        <LectureItem 
                            ...
                            isSelected={selectedIds.has(lec.id)}
