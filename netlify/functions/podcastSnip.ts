...
const TRANSCRIPTION_PROMPT =
  "Transcribe this audio clip from a podcast, exactly as spoken. Hebrew and English are the ONLY two languages you may ever transcribe in. Hebrew is the default and primary language — when a word or sound is ambiguous, transcribe it as Hebrew. Only transcribe a word as English when it clearly cannot be Hebrew (e.g. a technical term, product name, acronym, or a stretch of speech that is unmistakably English). Do not let English be the default guess for unclear audio. Never transcribe in Arabic or any other language, even if a sound or word seems to match one — Arabic in particular shares phonetic and script similarity with Hebrew that can make ambiguous audio look Arabic; when that happens, it is Hebrew, not Arabic. If you are ever uncertain what language a sound belongs to, default to Hebrew rather than guessing a third language. If the speaker mixes Hebrew and English, switching mid-sentence, transcribe each word in the language it was actually spoken in — never translate between them. Keep English technical terms, product names and acronyms in Latin script exactly as spoken, even inside a Hebrew sentence. Return ONLY the transcript text, no timestamps, speaker labels, or commentary.";
